...
interface StartupMatchModalProps {
  startup: Startup | null;
  onClose: () => void;
  onChat: () => void;
}

export function StartupMatchModal({ startup, onClose, onChat }: StartupMatchModalProps) {
        ...
        >
          ...
          <div className="relative flex items-center justify-center mb-6 h-28">
            ...
            <motion.div
              ...
              animate={{ x: [-70, -30, 0], opacity: [0, 1, 0], scale: [0, 1, 0.3] }}
            ...
            <motion.div
              ...
              animate={{ x: [-55, -20, 0], opacity: [0, 0.5, 0], scale: [0, 0.7, 0] }}
            ...
            <motion.div
              ...
              animate={{ scale: [0, 1.8, 0.8], opacity: [0, 0.7, 0] }}
            ...
            <motion.div
              ...
              animate={{ opacity: [0, 0, 1, 1], scale: [0, 0, 1.1, 1.0] }}
              transition={{ duration: 1.0, delay: 0.5, times: [0, 0.15, 0.55, 1], ease: [0.34, 1.56, 0.64, 1] }}
            >
              <motion.div
                initial={{ opacity: 0 }}
                ...
                style={{ background: "radial-gradient(circle, rgba(255,152,54,0.35) 0%, transparent 70%)" }}
              />
              <img src={connectxLogo} alt="ConnectX" className="w-[72px] h-[72px] relative drop-shadow-[0_0_16px_rgba(255,152,54,0.4)]" />
            </motion.div>
            ...
            {[0, 60, 120, 180, 240, 300].map((angle, i) => {
              ...
              return (
                <motion.div
                  ...
                  style={{ background: i % 2 === 0 ? "#FF9836" : "#FED12E" }}
                />
              );
            })}
          </div>
